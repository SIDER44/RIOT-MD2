// index.js - RIOT MD Full Update with Auto Menu
...
async function startBot() {
  ...
  sock.ev.on('messages.upsert', async ({ messages }) => {
    ...
    if (!fs.existsSync(sessionFile)) {
      // Send text menu first
      try {
        const menuCommand = require('./commands/fun/menu.js')
        await menuCommand.run(sock, msg, [])
      } catch (err) {
        console.log(chalk.red('Error sending menu:'), err)
      }
    }
